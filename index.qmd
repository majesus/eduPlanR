...
mtcars %>%
  ...
  head(3)
```
1. Aplica resúmenes por múltiples variables de agrupación
2. Ejecuta función personalizada en cada grupo manteniendo la estructura
3. Elimina agrupación para cálculos a nivel global
:::
...
3. Combina con otras operaciones
:::
